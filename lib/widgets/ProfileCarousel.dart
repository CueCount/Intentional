...
class _ProfileCarouselState extends State<ProfileCarousel> {
  ...
  Widget build(BuildContext context) {
    ...
    return CarouselSlider(
      ...
      // add inputs into this list at positions 4 and 8 
      items: List<Widget>.from(profiles.map<Widget>((profile) {
        ...
        // if statement for inputs, display screenshot reference if input, and the below code if profile
        return Align(
